 ...
 */
public class MyClientChannelPipelineFactory extends ClientInitializerFactory {

    private final int maxLineSize = 1024;

    public MyClientChannelPipelineFactory() {
    }

    public MyClientChannelPipelineFactory(NettyProducer np) {
        this.producer = np;
    }
    ...
    public ClientInitializerFactory createPipelineFactory(NettyProducer np) {
        return new MyClientChannelPipelineFactory(np);
    }
